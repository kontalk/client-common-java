 ...
 * </p>
 * <p>
 * Modified version from commit 6cfdf2bc6ff9c3a7c0cf0ff6c7bb9507c77f95fc.
 * </p>
 * 
 * @author Florian Schmaus
 * @see <a href="http://www.xmpp.org/extensions/xep-0199.html">XEP-0199:XMPP Ping</a>
 */
public class PingManagerV2 extends Manager {
    private static final Logger LOGGER = Logger.getLogger(PingManagerV2.class.getName());

    private static final Map<XMPPConnection, PingManagerV2> INSTANCES = new WeakHashMap<XMPPConnection, PingManagerV2>();
    ...
    /**
     * Retrieves a {@link PingManagerV2} for the specified {@link XMPPConnection}, creating one if it doesn't already
     * exist.
     * 
     * @param connection
     ...
     */
    public synchronized static PingManagerV2 getInstanceFor(XMPPConnection connection) {
    ...
    private PingManagerV2(XMPPConnection connection) {
        super(connection);
